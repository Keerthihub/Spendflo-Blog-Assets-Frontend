...
import { Template1RenderProps } from "./Template1Render.types";
import { Box, Button } from "@mui/material";
import Title from "../Title/Title";
import Template1Card from "./Template1Card";
import Template1bg from "../../assets/image/template1-bg.jpg";
import { useDownloadPNGRef } from "../../hooks/useDownloadPNGRef";

const Template1Render: React.FC<Template1RenderProps> = ({
  titleWidth,
  iconSize,
  squareSize,
  contentWidth,
...
export default Template1Render;
